...
<head>
    ...
    <link rel="stylesheet" href="../css/style-delete-prod.css">
...
<body>
    <form class="form" id="formulario" method="DELETE">
        ...
        <br>
        <p>Indica el producto que deseas borrar...</p>
    ...
    <script src="../js/delete-prod.js"></script>
