...
<head>
    ...
    <link rel="stylesheet" href="../css/style-watch-prod.css">
...
<body>
    <form class="form" id="formulario" method="GET">
        ...
        <h2>Ver productos de una categoria</h2>
        ...
        <br>
        <p>¿Qué productos te gustaría ver?...</p>
        <p type="Categoria:"><input type="input" name="categoria" id="categoria" placeholder="Digita la categoria de los productos que quieres ver"></input></p>
        <br><br>
    ...
    <script src="../js/watch-prod.js"></script>
